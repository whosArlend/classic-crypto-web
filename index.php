...
<?= (($_POST['algoritma'] ?? '') === 'vigenere') ? 'selected' : '' ?>>
Vigenere Cipher
</option>

<option value="affine"
<?= (($_POST['algoritma'] ?? '') === 'affine') ? 'selected' : '' ?>>
Affine Cipher
</option>

<option value="playfair"
<?= (($_POST['algoritma'] ?? '') === 'playfair') ? 'selected' : '' ?>>
Playfair Cipher
</option>

<option value="hill"
<?= (($_POST['algoritma'] ?? '') === 'hill') ? 'selected' : '' ?>>
Hill Cipher (2x2)
</option>

<option value="enigma"
<?= (($_POST['algoritma'] ?? '') === 'enigma') ? 'selected' : '' ?>>
Enigma Cipher
</option>
...
placeholder="Masukkan teks di sini..."><?= htmlspecialchars($_POST['input_teks'] ?? '') ?></textarea>
</div>

<div class="form-group">
<label>Key</label>
<input type="text" name="input_key"
value="<?= htmlspecialchars($_POST['input_key'] ?? '') ?>">
<small class="key-hint" id="keyHint"></small>
</div>
...
<strong>Hasil:</strong>
<p class="result"><?= htmlspecialchars($hasil); ?></p>
</div>
<?php endif; ?>
...
updateHint(algoritmaSelect.value);
